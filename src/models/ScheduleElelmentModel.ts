...
export interface ModifiedScheduleElementModel extends AbstractScheduleElementModel {
    comments: string | null,
    mseUuid: string,
    thisMseVersion: string
}

export interface UsualScheduleElementModel extends AbstractScheduleElementModel { }